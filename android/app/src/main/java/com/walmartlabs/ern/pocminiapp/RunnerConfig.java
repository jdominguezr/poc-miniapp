package com.walmartlabs.ern.pocminiapp;

import com.walmartlabs.ern.container.miniapps.PocMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = PocMiniappActivity.class;
